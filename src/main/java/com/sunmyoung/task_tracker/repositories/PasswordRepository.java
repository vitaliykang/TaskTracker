...
public class PasswordRepository {
    ...
    public static void resetPassword() {
        ...
        try {
            entityManager.getTransaction().begin();
            Password pass = entityManager.createQuery("from Password p where p.id = 2", Password.class).getSingleResult();
            String defaultPassword = pass.getPassword();
            pass = entityManager.createQuery("from Password p where p.id = 1", Password.class).getSingleResult();
